To start the server, run "npm start" from student 04 on the command line. Then, open a new browser window and go to URL: "http://student04.cse.nd.edu:51001/"
This will get you to the game lobby where a random username is generated for each player and a chat function exists. From another device, enter the same URL.
